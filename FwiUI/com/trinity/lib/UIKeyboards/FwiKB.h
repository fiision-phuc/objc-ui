...
@interface FwiKB : UIView <UIAppearanceContainer> {
    
@protected
    CGFloat _adjustHeight;  
    BOOL    _shouldHide;    // If turn on, the view will be completed invisible when keyboard is hided
}
